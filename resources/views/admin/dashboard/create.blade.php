...
@section('content')
    <div class="col-10 mx-auto mt-5">
        <div class="card mb-6">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.dashboard.create.store') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control" id="basic-icon-default-fullname"
                                    ...
                                    fdprocessedid="3tq798" name="name" value="{{ old('name') }}" required>
                            </div>
                            @error('name')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="number" id="basic-icon-default-company" class="form-control"
                                    ...
                                    fdprocessedid="7el9oe" name="price" value="{{ old('price') }}">
                            </div>
                            @error('price')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-10">
                            <button type="submit" class="btn btn-primary waves-effect waves-light"
                                fdprocessedid="1frc0q">Buat Product</button>
                        </div>
                    </div>
                </form>
            </div>
